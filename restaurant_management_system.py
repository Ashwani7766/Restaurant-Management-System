...
label_info = Label(top, font = ('arial',50,'bold'), text ="Restaurant Billing with GST", fg = "red", bd = 10, anchor = 'w')
...
def calculator1():
        ...
        btn7 = Button(right, padx= 16, pady=16, bd= 8, fg= "black", font= ('arial',20,'bold'), text="7",activebackground="red", bg="powder blue", command=lambda: btn_click(7))
        ...
        cut = Button(right, padx= 16, pady=16, bd= 8, fg= "black", font= ('arial',20,'bold'), text="X", bg="powder blue", command=fun_cut)
        cut.grid(row= 6, column= 0) 
        dot = Button(right, padx= 16, pady=16, bd= 8, fg= "black", font= ('arial',20,'bold'), text=".", bg="powder blue", command=lambda: btn_click("."))
...
txt_customer = Entry(left,font=('arial',16,'bold'), textvariable=rand, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_fries = Entry(left,font=('arial',16,'bold'), textvariable=fries_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_Sandwich = Entry(left,font=('arial',16,'bold'), textvariable=Sandwich_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_burger = Entry(left,font=('arial',16,'bold'), textvariable=burger_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
txt_burger.grid(row=3,column=1)

drinks = Label(left, font=('arial',16,'bold'),text = "Coffee", bd = 16, anchor = 'w' )
drinks.grid(row=4,column=0,sticky = E)
txt_drinks = Entry(left,font=('arial',16,'bold'), textvariable=drinks_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_Pasta = Entry(left,font=('arial',16,'bold'), textvariable=Pasta_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_Tacos = Entry(left,font=('arial',16,'bold'), textvariable=Tacos_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_subtotal = Entry(left,font=('arial',16,'bold'), textvariable=subtotal_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_services = Entry(left,font=('arial',16,'bold'), textvariable=services_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_tax = Entry(left,font=('arial',16,'bold'), textvariable=tax_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_cost = Entry(left,font=('arial',16,'bold'), textvariable=cost_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
...
txt_total = Entry(left,font=('arial',16,'bold'), textvariable=total_inp, bd=10, insertwidth =4,bg = "red", justify ='right')
txt_total.grid(row=5,column=3) 


### right Frame Button ###########

btn_total = Button(left, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Total", bg= "red",command = ref)
btn_total.grid(row=7, column= 1)

btn_reset = Button(left, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Reset", bg= "red",command = reset)
...
btn_bck = Button(left, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Back", bg= "red",command = bck)
btn_bck.grid(row=8, column= 2)
btn_calculator = Button(left, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Calculator", bg= "red",command = calculator1)
btn_calculator.grid(row=8, column= 3)
